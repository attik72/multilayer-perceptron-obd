...
public class Versicolor {
	
	private TrainingSet trainingSet = new TrainingSet();
	static String name = "iris_versicolor.data";
	private TrainingSet learningTS = new TrainingSet();
	private TrainingSet testTS = new TrainingSet();

	public Versicolor(int numLearningEl) {
		 try {
             trainingSet = TrainingSetImport.importFromFile(Versicolor.name, 4, 1, ",");
